    ...
    <div id="home" className='w-full flex flex-row flex-wrap justify-evenly items-center gap-8 mb-8 pt-20'>
        ...
        <div className='flex flex-col'>
            <div className=''>
                ...
                <p className='text-[salmon] text-2xl md:text-3xl text-center font-semibold'>{showLanguage === "spanish" ? "soy" : "I'am"} <span className='text-[salmon] text-xl md:text-3xl font-semibold'>Oscar Miguel Luciani</span></p>
                
                <p className={`${theme === "light" ? "text-black" : "text-white"} text-lg md:text-2xl text-center font-semibold mt-[3px] ${showTransitionInicio ? "inicio-transition" : ""}`}>Frontend Developer</p>
            </div>
        </div>
