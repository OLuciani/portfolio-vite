          ...
          <div className="caja-luciani-automoviles">
            <div className="px-[3%] mb-[1%] text-left">
              ...
              >
                ...
                <br />
                {showLanguage === "spanish"
                  ? `Es una aplicación híbrida desarrollada para conectar usuarios con descuentos en restaurantes, bares, panaderías, cafeterías y otros locales de comida. La plataforma permite a los negocios administrar sus cuentas y publicar promociones, mientras que los usuarios pueden explorar descuentos disponibles cerca de ellos desde su dispositivo móvil.`
                  : `It is a hybrid application designed to connect users with discounts at restaurants, bars, bakeries, cafes, and other food establishments. The platform allows businesses to manage their accounts and post promotions, while users can explore discounts near them from their mobile devices.`}
                <br />
                {showLanguage === "spanish"
                  ? `Herramientas utilizadas: En el frontend web, utilicé Next.js con TypeScript, Tailwind CSS y Material UI para ofrecer una interfaz moderna y responsiva. La aplicación móvil se desarrolló con React Native y Expo. Para el backend, implementé Node.js y Express.js, y la base de datos se gestionó con MongoDB Atlas.`
                  : `Tools used: For the web frontend, I used Next.js with TypeScript, Tailwind CSS, and Material UI to provide a modern and responsive interface. The mobile application was developed using React Native and Expo. For the backend, I implemented Node.js and Express.js, with MongoDB Atlas for database management.`}
              </span>
            </div>
            ...
            <div className="px-[3%] flex flex-wrap">
              ...
              <div className="lg:w-[40%] mt-2 flex flex-col items-center justify-center gap-2 lg:gap-3">
                ...
                <div className="px-[3%]">
                  <p>
                    Puedes entrar a la app como usuario visitante, utilizando el
                    email ficticio de prueba user_visit@demo.com y la contraseña
                    12345678 (este usuario tiene el rol que tendría un empleado
                    asociado a la cuenta de un negocio). Puedes crear, editar y
